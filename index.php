...
<head>
	<base href="http://localhost/eunovate/mmevents-admin/"/>
	<script> var BASE_URL = "/eunovate/mmevents-admin/service/index.php/";</script>
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand " href="#"><span class="logofont"><img src="./static/img/eunovate/logo.png" width="30px;" /> MM Events</span> Admin Portal</a>
				</div>
					...
					<ul class="nav navbar-nav">
						...
						<li ng-class="{active: getpath()=='user-list' ||
							...
							<ul class="dropdown-menu">
								...
								<li><a href="city-list"><span class="fa fa-gears"></span> App Settings</a></li>
...
<script type="text/javascript" src="./app/controllers/class_status_ctrl.js"></script>
<script type="text/javascript" src="./app/controllers/report_ctrl.js"></script>
<script type="text/javascript" src="./app/controllers/comment_ctrl.js"></script>
<script type="text/javascript" src="./app/controllers/level_ctrl.js"></script> -->
<script type="text/javascript" src="./app/controllers/city_ctrl.js"></script>
<script type="text/javascript" src="./app/controllers/township_ctrl.js"></script>
<!--<script type="text/javascript" src="./app/controllers/vehicle_location_ctrl.js"></script> -->
<!-- -->
