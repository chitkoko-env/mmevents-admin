   ...
   <!-- user dialog -->
    <script type="text/ng-template" id="userdialog">
                  ...
                  <fieldset>
                   <div class="form-group col-md-12" ng-class="{'has-error': userForm.gname.$invalid}">
                    ...
                    <div class="form-group col-md-12">
                        <label class="control-label col-md-4" for="position">Title :</label>
                        <div class="controls col-md-8">
                            <input type="text" class="form-control" name="position" ng-model="position"/>            
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-12" ng-class="{'has-error': userForm.dob.$invalid}">
                      <label class="control-label col-md-4" for="dob">Date of Birth:</label>
                      <div class="controls col-md-8">
                          <input type="date" class="form-control" name="dob" ng-model="dateofbirth" required/>
                      </div>
                    </div>
                    ...
                    <div class="form-group col-md-12" ng-class="{'has-error': userForm.startdate.$invalid}">
                      <label class="control-label col-md-4" for="startdate">Start Date:</label>
                      <div class="controls col-md-8">
                          <input type="date" class="form-control" name="startdate" ng-model="startdate" required/>
                      </div>
                    </div>
                    <div class="form-group col-md-12">
                        <label class="control-label col-md-4" for="status">Status :</label>
                        <div class="controls col-md-8">
                            <label class="radio-inline"><input type="radio" name="statussel" ng-model="statussel" value="1" />Full Time</label> 
                            <label class="radio-inline"><input type="radio" name="statussel" ng-model="statussel" value="2" />Part Time</label> 
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button ng-click="saveuser()" ng-disabled="userForm.$invalid || isNameErr || oneclickbtn" class="btn btn-default">
